            ...
            <Col md={6}>
                    ...
                    <Col md={12}>
                        <div className='d-flex gap-2 align-items-center'>
                            ...
                            <div className='uploader'>
                                {burnImages.length === 0 ? (
                                    <Image src='/img/placeholder.png' alt='Burn' />
                                ) : (
                                    <>
                                            ...
                                            <div key={index} className='image-container position-relative'>
                                                ...
                                                <div className='delete-overlay'>
                                                    <Button className='p-0' variant='transparent'
                                                        onClick={() => handleDeleteImage(index, setProbleImages)}
                                                    >
                ...
                <Row className='mt-4'>
                    <Col md={12}>
                        <div className='d-flex gap-2 align-items-center'>
                            <Form.Group className='w-100'>
                                <Form.Label>Measurement photo with censor</Form.Label>
                                <Form.Control
                                    type='file'
                                    id='probleImage'
                                    accept='.jpg,.jpeg,.png'
                                ...
                                {probleImages.length === 0 ? (
                                    ...
                                    <>
                                        {probleImages.map((image, index) => (
                                            <div key={index} className='image-container position-relative'>
                                                <Image src={image} alt={`Proble ${index + 1}`} />
                                                <div className='delete-overlay'>
                                                    <Button className='p-0' variant='transparent'
                                                        onClick={() => handleDeleteImage(index, setProbleImages)}
                                                    >
                ...
                <Row className='mt-4'>
                    <Col className='mb-2' md={12}>
                        <div className='d-flex gap-4 align-items-center'>
                            <Form.Group>
                                <Form.Label className='m-0 lc'>ANATOMICAL LANDMARK*</Form.Label>
                            </Form.Group>
                        </div>
                    </Col>
                    <Col md={12}>
                        <Form.Select aria-label="NanoVNA" className='form-control'>
                            <option value="Thigh">Thigh: Left & Right (Separately)</option>
                            <option value="Lowerlimb">Lower limb: Left & Right (Separately)</option>
                            <option value="Arms">Arms: Left & Right (Separately)</option>
                            <option value="Forearm">Forearm: Left & Right (Separately)</option>
                        </Form.Select>
                    </Col>
                </Row>
                <Row className='mt-4'>
                    <Col className='mb-2' md={12}>
                        <Form.Group>
                            <Form.Label className='m-0 lc'>Description</Form.Label>
